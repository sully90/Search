...
package persistence.elastic.client.bulk.configuration;

import org.elasticsearch.action.bulk.BulkProcessor;
import org.elasticsearch.client.Client;
import persistence.elastic.client.bulk.listener.LoggingBulkProcessorListener;
import persistence.elastic.client.bulk.options.BulkProcessingOptions;
import persistence.elastic.client.bulk.options.BulkProcessingOptionsBuilder;
